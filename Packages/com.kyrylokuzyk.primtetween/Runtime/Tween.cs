...
namespace PrimeTween {
    ...
    public
        ...
        public Tween OnComplete([CanBeNull] Action onComplete, bool warnIfTargetDestroyed = true, [CanBeNull] Func<bool> onIsNull = null) {
            if (validateIsAlive()) {
                tween.OnComplete(onComplete, warnIfTargetDestroyed, onIsNull);
            }
            return this;
        }
        ...
        /// </code></example>
        public Tween OnComplete<T>([NotNull] T target, [CanBeNull] Action<T> onComplete, bool warnIfTargetDestroyed = true, [CanBeNull] Func<T, bool> onIsNull = null) where T : class {
            if (validateIsAlive()) {
                tween.OnComplete(target, onComplete, warnIfTargetDestroyed, onIsNull);
            }
            return this;
        }
