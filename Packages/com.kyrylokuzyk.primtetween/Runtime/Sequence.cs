...
namespace PrimeTween {
    ...
    public
        ...
        public Sequence OnComplete(Action onComplete, bool warnIfTargetDestroyed = true, Func<bool> onValidate = null) {
            root.OnComplete(onComplete, warnIfTargetDestroyed, onValidate);
            return this;
        }

        public Sequence OnComplete<T>(T target, Action<T> onComplete, bool warnIfTargetDestroyed = true, Func<T, bool> onValidate = null) where T : class {
            root.OnComplete(target, onComplete, warnIfTargetDestroyed, onValidate);
            return this;
        }
